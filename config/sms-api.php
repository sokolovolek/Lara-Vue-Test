...
return [
    ...
    'default' => env('SMS_API_DEFAULT_GATEWAY', 'movesms'), //Choose default gateway
...
//    SMSNIX Sample Config
    ...
    'movesms' => [
        ...
        'params' => [
            ...
            'others' => [
                'username' => 'akademico', //Your username
                // 'password' => '', //Your Password
                'api_key'=>'DtQVOpaC2BhRYnoCijrpiQdNsCk0Mr0ISuGzoFcy71rk4w1dr5', //the api key 
                'sender' => 'GENIUS', //Your Sender ID
                'msgtype' => '5',
                'dlr' => '1',
            ],
        ],
